...
export default function Page() {
  ...
  useEffect(() => {
    fetch('https://api.github.com/repos/vochsel/walkie-talkie')
      .then(r => r.json())
  ...
  return (
    ...
    >
        ...
        >
          ...
          <div className="nav-links" style={{ display: 'flex', alignItems: 'center', gap: 28 }}>
            ...
            >
              ...
              GitHub{stars !== null ? <><span style={{ display: 'inline-block', width: 1, height: 12, background: BORDER, margin: '0 8px', verticalAlign: -1 }} /><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" style={{ verticalAlign: -2, marginRight: 3 }}><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>{stars >= 1000 ? `${(stars / 1000).toFixed(1)}k` : stars}</> : ''}
            </a>
          </div>
        </div>
      </nav>
      ...
      <section id="how-it-works" style={sectionStyle}>
        <div style={container}>
          <h2 className="section-heading" style={sectionHeading}>How it works</h2>
          <p style={sectionSub}>
      ...
      <section id="build" style={sectionStyle}>
        <div style={container}>
          <h2 className="section-heading" style={sectionHeading}>Packages</h2>
          <p style={sectionSub}>
      ...
      <section id="protocol" style={sectionStyle}>
        <div style={container}>
          <h2 className="section-heading" style={sectionHeading}>Protocol reference</h2>
